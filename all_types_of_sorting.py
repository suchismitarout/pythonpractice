...
num_list = [23, 12, 44, 1, 56, 33, 18, 6]
merge_sort(num_list)
print(num_list)
...
def heapify(num_list, n, i):
    ...
    left = i * 2 + 1
    right = i * 2 + 2
    while left < n and num_list[largest] < num_list[left]:
        largest = left

    while right < n and num_list[largest] < num_list[right]:
        largest = right

    if largest != i:
        num_list[largest], num_list[i] = num_list[i], num_list[largest]
...
bubble_sort([23, 12, 44, 1, 56, 33, 18, 6])
...
selection_sort([23, 12, 44, 1, 56, 33, 18, 6])
...
insertion_sort([23, 12, 44, 1, 56, 33, 18, 6])
